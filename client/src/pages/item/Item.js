      ...
      <div className='Wrapper'>
        ...
        <div className='Wrapper-right-col'>
          ...
          <div className='Item-description'>
            <p>
              This is the rarest, coolest sticker you will ever find, for the
              best price ever that no one can match. Show that you are a proud
              Tuffy by putting this sticker on your laptop, water bottle, or
              wherever you feel like.
            </p>
          </div>
          <div className='Seller-location'>
            <FontAwesomeIcon
              className='Seller-location-icon'
              icon={faLocationDot}
            />
